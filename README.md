...
外部 ICMP/TCP echo 与网络窗回收。root manager 不再链接或运行 LKL。详见
[`PHASE2.1-RESULTS.md`](PHASE2.1-RESULTS.md) 和
[`PHASE2.2-RESULTS.md`](PHASE2.2-RESULTS.md)、
[`PHASE2.3-RESULTS.md`](PHASE2.3-RESULTS.md)、
[`PHASE2.4-RESULTS.md`](PHASE2.4-RESULTS.md) 和
[`PHASE2.5-RESULTS.md`](PHASE2.5-RESULTS.md)。
...
| network | manager-owned QEMU virtio-net-pci + 8KiB packet window；child LKL 固定 IPv4/ICMP/TCP |
...
静态 ABI 尚不支持 pipeline/native fork/exec，网络 RX 当前使用同步 poll Endpoint，且默认测试对端
